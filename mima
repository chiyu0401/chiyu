...
url = "http://images.jpg.cat.cy.com"
...
def put_txt_contents(new_url_list, dict_list, file_name="dict"):
    with open(f"new_{file_name}.txt", "a", newline="") as f:
...
# 第一个参数用range值，第二个参数是用其他的range的值
# print(dicts)
